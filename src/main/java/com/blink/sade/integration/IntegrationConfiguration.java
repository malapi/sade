...
public class IntegrationConfiguration extends Configuration {
    @NotEmpty
    ...
    @NotEmpty
    private String sadeUrl = "http://sade-mule.hml.gcba.gob.ar/";
    ...
    @JsonProperty
    public String getSadeUrl() {
        return sadeUrl;
    }

    @JsonProperty
    public void setSadeUrl(String url) {
        this.sadeUrl = url;
    }
}
