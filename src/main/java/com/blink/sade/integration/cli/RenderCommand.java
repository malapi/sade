package com.blink.sade.integration.cli;

import com.blink.sade.integration.IntegrationConfiguration;
...
public class RenderCommand extends ConfiguredCommand<IntegrationConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<IntegrationConfiguration> bootstrap,
                       Namespace namespace,
                       IntegrationConfiguration configuration) throws Exception {
